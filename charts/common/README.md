...
![Version: 1.12.1](https://img.shields.io/badge/Version-1.12.1-informational?style=flat-square) ![Type: library](https://img.shields.io/badge/Type-library-informational?style=flat-square)
...
Designed to be used as a dependency by application charts (web, worker, task).
...
| `common.cronjobs` | CronJob resources (map-based) |
| `common.jobs` | Job resources (map-based) |
...
| `common.extraObjects` | Arbitrary Kubernetes resources (list, or map keyed by name for overlay-friendly merging) |
...
----------------------------------------------
Autogenerated from chart metadata using [helm-docs v1.12.1](https://github.com/norwoodj/helm-docs/releases/v1.12.1)
