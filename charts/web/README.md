...
|-----|------|---------|-------------|
| commonLabels."admission.datadoghq.com/enabled" | string | `"true"` |  |
| commonLabels."tags.datadoghq.com/service" | string | `"{{ include \"common.fullname\" . }}"` |  |
| commonLabels."tags.datadoghq.com/version" | string | `"{{ .Values.image.tag | default \"latest\" }}"` |  |
...
| workloadAnnotations."reloader.stakater.com/auto" | string | `"true"` |  |

----------------------------------------------
Autogenerated from chart metadata using [helm-docs v2.0.0](https://github.com/norwoodj/helm-docs/releases/v2.0.0)
